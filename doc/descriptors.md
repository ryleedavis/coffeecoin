# Support for Output Descriptors in Coffeecoin Core

Since Coffeecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Coffeecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Coffeecoin Core wallets, a convenience function `combo` is
