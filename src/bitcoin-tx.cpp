...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " Coffeecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  Coffeecoin-tx [options] <hex-tx> [commands]  Update hex-encoded Coffeecoin transaction\n" +
            "or:     Coffeecoin-tx [options] -create [commands]   Create hex-encoded Coffeecoin transaction\n" +
            "\n";
