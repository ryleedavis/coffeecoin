...
#if defined(NDEBUG)
# error "Coffeecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Coffeecoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
...

    {
        ...
        for (CTxMemPool::txiter it : allConflicting)
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s CFE additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("Coffeecoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    if (block.GetHash() 1= chainparams.GetConsensus().hashGenesisBlock)
    {
