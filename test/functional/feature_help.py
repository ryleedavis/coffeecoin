...
"""Verify that starting Coffeecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Coffeecoin with -h for help text")
        ...
        self.log.info("Start Coffeecoin with -version for version information")
        ...
        self.log.info("Start Coffeecoind with -fakearg to make sure it does not start")
